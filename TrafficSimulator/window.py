...
class Window:
    def __init__(self, simulation):
        ...
        self._current_algorithm_text: str = ""
    ...
    def update_algorithm_text(self, algorithm_name):
        """Updates the text displaying the current algorithm."""
    ...
    def _draw_signals(self) -> None:
        for signal in self._sim.traffic_signals:
            for i, road_group_indices in enumerate(signal.road_indices):
                red, green = (255, 0, 0), (0, 255, 0)
                color = green if signal.current_cycle[i] else red

                for road_index in road_group_indices:
                    if 0 <= road_index < len(self._sim.roads):
                        road = self._sim.roads[road_index]
                        a = 0  # Adjust for signal position along the road
    ...
    def _draw_status(self):
        ...
        current_algorithm = render(f'Algorithm: {self._current_algorithm_text}')
        ...
        self._screen.blit(current_algorithm, (10, 150))  # Display current algorithm
